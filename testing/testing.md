...
| if username is edited then recipe collection is not updated with new username so user loses their recipes                                                                              | recipe collection of user now updated when username is changed                                                                                                                                                                                                                          |
