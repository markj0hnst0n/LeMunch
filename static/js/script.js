$(document).ready(function () {
    ...
    $(add_method_step_button).click(function(e){ //on add method step button click
		...
		if(method_step_count < max_fields){ //max method step box allowed
			...
			$(method_fields_wrapper).append('<div><i class="material-icons prefix">edit</i><input type="text" name="method" class="validate"/><a href="#" class="btn-small btn-colour remove_field">Remove</a></div>'); //add method step box
		}
	});
